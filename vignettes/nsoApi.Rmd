...
```{r beaapi-getdata, echo=TRUE, eval=TRUE, results='as.is'}
api.param <- list(
  DATASETNAME = "GDPBYINDUSTRY",
  FREQUENCY = "A",
  INDUSTRY = "11",
...
```{r cbs-dimension, eval=TRUE, echo=TRUE, results='as.is'}
...
```{r cbs-data, eval=TRUE, echo=TRUE, results='as.is'}
scheme <- "TypedDataSet"
# print query
cbsODataAPI(api=api, DSD=DSD, scheme=scheme, query=TRUE)
...
```{r genesis-tables, eval=TRUE, echo=TRUE, results='as.is'}
...
```{r ons-data, eval=TRUE, echo=TRUE, results='as.is'}
...
```{r ons-tables, eval=TRUE, echo=TRUE, results='as.is'}
...
```{r finstat-data, eval=TRUE, message=FALSE, echo=TRUE, results='as.is'}
...
```{r scb-data, message=FALSE, results='as.is'}
...
```{r ssb-data, message=FALSE, results='as.is'}
